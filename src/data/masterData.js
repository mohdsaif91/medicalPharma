...
export const masterData = [
  ...
  },
  {
    ...
    additionalDetials:
      "Look at the skin that you plan to cover with a lidocaine patch. If the skin is broken or blistered, do not apply a patch to that area. Use scissors to remove the outer seal from the package. Then pull apart the zipper seal.Remove up to three patches from the package and press the zipper seal tightly together. The remaining patches may dry out if the zipper seal is not tightly closed.  Cut patch(es) to the size and shape that will cover your most painful area. Peel the transparent liner off the back of the patch(es). Press the patch(es) firmly onto your skin. If you are applying a patch to your face, be careful not to let it touch your eyes. If you do get lidocaine in your eye, wash it with plenty of water or saline solution. Wash your hands after handling lidocaine patches. Do not reuse lidocaine patches. After you are finished using a patch, remove it and dispose of it out of reach of children and pets. Used patches contain enough medication to seriously harm a child or pet.",
  },
  {
    productId: 4,
